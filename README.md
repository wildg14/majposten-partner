...
3. **Verifiera på Pages-adressen** vid 1100 px och 390 px mot `design/annonsera-desktop.png` och `design/annonsera-mobil.png`. Sidorna ska vara identiska så när som på logotypen. Kontrollera att båda knapparna öppnar `mailto:daniel@tvartom.win?subject=Partner%20i%20Majposten`.
